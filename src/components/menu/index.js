...
export default function TopMenu(props) {
    ...
    return (
        <Menu onClick={handleClick} selectedKeys={current} onClick={handleClick} mode="horizontal" className="menu">
            <Menu.Item key="name">
                <Link to="/">
                    {language=='English'?'Robert Huo':'霍达'}
                </Link>
            </Menu.Item>
            ...
            <Menu.Item key="resume" icon={<FileDoneOutlined />}>
              <a href='https://github.com/DAHUO-Melbourne/robert-huo-blog/raw/master/src/RobertHuoResume.pdf' rel='noopener noreferrer' download>{language=='English'?'Resume':'简历'}</a>
            </Menu.Item>
